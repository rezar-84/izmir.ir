   ...
   class element_gva_icon_box_classic{
      ...
      public static function render_content( $attr = array(), $content = '' ){
         ...
         <?php if($icon_position=='top-center' || $icon_position=='top-left' || $icon_position=='top-right' || $icon_position=='right' || $icon_position=='left'){ ?>
            <div class="widget gsc-icon-box <?php print gavias_implode_classes($class) ?>" <?php print gavias_implode_style($style) ?> <?php print gavias_content_builder_print_animate_wow('', $animate_delay) ?>>
